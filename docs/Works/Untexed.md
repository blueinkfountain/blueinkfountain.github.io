...
<div class="academic-tree-container">
  ...
  {% for folder in latest_folders %}
    ...
    {% if current_subject != last_subject %}
      ...
      {% if latest_record %}
        ...
        {% if latest_record.subject_ink_percent %}
          ...
          {% assign subject_ink =
            latest_record.subject_ink_percent[current_subject]
          %}
    ...
    Algebra / 3. Finite Group Theory +25.0% ink
    ========================================================
    {%- endcomment -%}
    ...
    {% if latest_record %}
      ...
      {% if latest_record.folder_ink_percent %}
        ...
        {% assign folder_ink =
          latest_record.folder_ink_percent[folder]
        %}
            ...
            {% if file_date == latest_date %}
              ...
              {% for part in parts %}
                ...
                {% if forloop.index > 3 and forloop.last == false %}
                  ...
                  {% assign current_folder_parts =
                    current_folder_parts | push: part
                  %}
              ...
              {% if current_folder == folder %}
                ...
                {% assign raw_relative_path =
                  file.path | remove_first: latest_prefix
                %}
                ...
                {% if latest_record %}
                  ...
                  {% if latest_record.file_ink_percent %}
                    ...
                    {% assign file_ink =
                      latest_record.file_ink_percent[raw_relative_path]
                    %}
          ...
          {% unless date == latest_date %}
            ...
            <details class="version-folder">
              ...
              <div class="version-content">
                ...
                {% assign version_record =
                  site.data.untexed_records[date]
                %}
                ...
                <details class="version-files-toggle">
                  ...
                  <div class="version-files">
                      ...
                      {% if file.extname == ".pdf" or file.extname == ".PDF" %}
                        ...
                        {% if file_date == date %}
                          ...
                          {% unless version_folders contains folder_name %}
                            ...
                            {% assign version_folders =
                              version_folders | push: folder_name
                            %}
                    ...
                    {% for folder in version_folders %}
                      ...
                      {% assign subject_parts =
                        folder | split: " / "
                      %}


                      {% assign current_subject =
                        subject_parts[0]
                      %}
