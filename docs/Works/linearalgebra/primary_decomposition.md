---
layout: default
title: The Primary Decomposition
parent: Canonical Form
nav_order: 2
---

# Decompose to Diagonal and Nilpotent operators which are commmute.
...
<div style="width: 100%; height: 120vh; min-height: 500px; border: 1px solid #eee; border-radius: 8px; overflow: hidden;">
    <iframe 
        src="https://docs.google.com/viewer?url=https://blueinkfountain.github.io/assets/pdfs/260619_02.pdf&embedded=true" 
        width="100%" 
        height="100%" 
        style="border: none;">
    </iframe>
